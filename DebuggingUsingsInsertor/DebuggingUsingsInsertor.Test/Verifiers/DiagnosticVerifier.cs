...
namespace TestHelper
{
	...
	public abstract partial class DiagnosticVerifier
	{
		...
		/// DiagnosticResult in the array of expected results. Diagnostics are considered equal only
		/// if the DiagnosticResultLocation, Id, Severity, and Message of the DiagnosticResult match
					...
					if( rule != null && rule.Id == diagnostics[i].Id )
					{
						...
						else
						{
							...
							string resultMethodName = diagnostics[i].Location.SourceTree.FilePath
								.EndsWith( ".cs", System.StringComparison.InvariantCulture ) ? "GetCSharpResultAt" : "GetBasicResultAt";
