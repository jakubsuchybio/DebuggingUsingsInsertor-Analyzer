...
namespace TestHelper
{
	...
	public abstract partial class CodeFixVerifier : DiagnosticVerifier
	{
		...
		static IEnumerable<Diagnostic> GetCompilerDiagnostics(Document document) => document.GetSemanticModelAsync().Result.GetDiagnostics();

		/// <summary>
		/// Compare two collections of Diagnostics,and return a list of any new diagnostics that
		/// appear only in the second collection.
		/// Note: Considers Diagnostics to be the same if they have the same Ids. In the case of
		///       multiple diagnostics with the same Id in a row, this method may not necessarily
		/// return the new one.
		/// </summary>
