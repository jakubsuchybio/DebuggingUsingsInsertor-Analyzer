...
namespace USI.Test
{
	public class Tests : CodeFixVerifier
	{
		...
		const string miss2 = "Missing these usings:" + n + "System.Linq";
		const string miss3 = "Missing these usings:" + n + "System.Collections.Generic";
		const string miss12 = "Missing these usings:" + n + "System" + n + "System.Linq";
		const string miss13 = "Missing these usings:" + n + "System" + n + "System.Collections.Generic";
		const string miss23 = "Missing these usings:" + n + "System.Linq" + n + "System.Collections.Generic";
		const string miss123 = "Missing these usings:" + n + "System" + n + "System.Linq" + n + "System.Collections.Generic";

		const string u1 = "using System;";
		const string u2 = "using System.Linq;";
		const string u3 = "using System.Collections.Generic;";
