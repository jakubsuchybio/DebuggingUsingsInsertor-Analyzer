...
namespace TestHelper
{
	...
	public abstract partial class DiagnosticVerifier
	{
		...
		/// diagnostics found in it. The returned diagnostics are then ordered by location in the
		/// source document.
		/// </summary>
		...
		/// <summary>
		/// Given classes in the form of strings, their language, and an IDiagnosticAnlayzer to
		/// apply to it, return the diagnostics found in the string after converting it to a document.
		/// </summary>
		...
		/// <summary>
		/// Given an array of strings as sources and a language, turn them into a project and return
		/// the documents and spans of it.
		/// </summary>
		/// <param name="sources">Classes in the form of strings</param>
		/// <param name="language">The language the source code is in</param>
		/// <returns>
